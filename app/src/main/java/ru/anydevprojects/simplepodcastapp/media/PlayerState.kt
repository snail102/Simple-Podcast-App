...
internal class PlayerStateImpl(
    ...
    override var trackSelectionParameters: TrackSelectionParameters by mutableStateOf(
    ...
    @get:Player.PlaybackSuppressionReason
    override var playbackSuppressionReason: Int by mutableIntStateOf(
    ...
    override var maxSeekToPreviousPosition: Long by mutableLongStateOf(
        player.maxSeekToPreviousPosition
    )
        private set
